...
# spatialDE
BiocManager::install("spatialDE", dependencies = TRUE)
...
# Repository for curated single-cell datasets
BiocManager::install("scRNAseq", dependencies = TRUE)

# Transforming Seurat objects
